...
public class SearchController {
    ...
    public ResponseEntity<List<UserSuggestionDto>> suggestUsers(@RequestParam("keyword") String keyword) {
        return ResponseEntity.ok(searchService.getUserSuggestions(keyword));
    }
